...
class TelegramCalendar:
    ...
    def __init__(self, calendar_id=0, current_date=None, additional_buttons=None, locale='en', min_date=None,
        ...
        :param date current_date: Where calendar_tg starts, if None the current date is used
        :param view: The type of the calendar_tg: either detailed, w/month, or w/year
        """
        ...
        if self.telethon and not TELETHON_INSTALLED:
            raise ImportError(
                "Telethon is not installed. Please install telethon or use pip install python-telegram-bot-calendar_tg[telethon]")
